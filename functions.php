...
if ( ! function_exists( 'soapatrickfive_setup' ) ) :
	...
	function soapatrickfive_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'soapatrickfive' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'soapatrickfive_custom_background_args', array(
...
function soapatrickfive_scripts() {
	...
	wp_enqueue_script( 'soapatrickfive-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'soapatrickfive-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
